...
import {
  PressableIconProps,
  PressableVectorIconProps,
  VectorIconProps,
  VectorIconReturnType,
} from './types';
...
function PressableIcon(props: PressableIconProps): JSX.Element {
  ...
  return (
    <Pressable
      ...
      onPressOut={() =>
        props.onPress ? setOpacity(unpressedOpacity) : undefined
      }>
      {props.children}
      <View
        style={{
...
export default function PressableVectorIcon(
  props: PressableVectorIconProps,
): VectorIconReturnType {
